...
public class DetailActivityKetemuanDiterima extends AppCompatActivity implements View.OnClickListener {
    ...
    private LinearLayout layout_lokasi;
    private LinearLayout layout_konfirmasi_lokasi_ketemuan;
    private Button btn_konfirmasi_lokasi_ketemuan;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_detail_ketemuan_diterima);
        ...
        MemberFirebase memberFirebase= new MemberFirebase(DetailActivityKetemuanDiterima.this);
        memberFirebase.getMemberEmail(this,ketemuan.getEmail_sender());
        ...
        this.layout_lokasi=(LinearLayout)findViewById(R.id.layout_lokasi);
        ...
        this.btn_konfirmasi_lokasi_ketemuan=(Button)findViewById(R.id.btn_konfirmasi_lokasi_ketemuan);
        this.layout_konfirmasi_lokasi_ketemuan=(LinearLayout)findViewById(R.id.layout_konfirmasi_lokasi_ketemuan);
    ...
    private void init_ui(){
        ...
        if (!ketemuan.getTempat_ketemuan().matches("")){
            this.layout_lokasi.setVisibility(View.VISIBLE);
            this.btn_lihat_lokasi.setVisibility(View.VISIBLE);
            this.btn_konfirmasi_lokasi_ketemuan.setText("Ubah lokasi transaksi");
        }else{
            this.layout_konfirmasi_lokasi_ketemuan.setVisibility(View.VISIBLE);
        ...
        Image image=new Image(DetailActivityKetemuanDiterima.this,"http://maps.googleapis.com/maps/api/staticmap?zoom=17&size=1200x800&maptype=roadmap&markers=color:red%7C"+ketemuan.getLatitude()+","+ketemuan.getLongitude()+"&key=AIzaSyCEZFJ3d8Ky8pNd9fJSf33v2wR29_TOpJw",gambar_lokasi_ketemuan);
        image.showImage();

        this.btn_konfirmasi_lokasi_ketemuan.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                KetemuanControl ketemuanControl=new KetemuanControl(DetailActivityKetemuanDiterima.this);
                ketemuanControl.konfirmasiLokasi(ketemuan);
            }
        });
    }
...
//
    ...
    private void goMaps(){
        finish();
        Intent i= new Intent(DetailActivityKetemuanDiterima.this, RuteKetemuanActivity.class);
    ...
    public void setMember(Member member){
        ...
        getSupportActionBar().setTitle("Ketemuan Dengan "+member.getNama());

        this.nama_ketemuan.setText(member.getNama());
    }
    ...
    public void onBackPressed() {
        finishAffinity();
        startActivity(new Intent(DetailActivityKetemuanDiterima.this, DaftarKetemuanActivity.class));
